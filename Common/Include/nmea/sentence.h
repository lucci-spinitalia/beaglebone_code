 ...
 */
enum nmeaPACKTYPE  // ADD: add packets type definition here
{
    ...
    HCHDT   = 0x0040,   /**< HDT - Heading relative to True North. */
    TIROT   = 0x0080,   /**< ROT - Rate of Turn */
    YXXDR   = 0x0100    /**< XDR - Trasducer Measurements */
};
...
/**
 * HDG packet information structure (Heading, Deviation and Variation)
 */
...
/**
 * HDG packet information structure (Heading relative to True North)
 */
typedef struct _nmeaHCHDT
{
    double direction;   /**< heading (degrees) */
    char t_flag;    /**< [T]rue */
} nmeaHCHDT;
 ...
 */
typedef struct _nmeaTIROT
{
    double rate;      /**< Rate of turn (degrees per minute) */
    char status;      /**< Status (A = Data Valid, V = Data Invalid) */
} nmeaTIROT;

/**
 * YXXDR packet information structure (Trasducer Mesurements: pitch, roll)
 */
typedef struct _nmeaYXXDR
{
    char angular_pitch;      /**< Angular Displacement (const) */
    double pitch;      /**< Oscillation of vessel about its latitudinal axis. Bow moving up is positive (degree) */
    char degrees_pitch;      /**< Degrees (const) */
    char pitch_id[4];  /**< ID indicating pitch of vessel */
    char angular_roll;  /**< Angular displacement (const) */
    double roll;        /**< Oscillation of vessel about its longitudinal axis. Roll to the starboard is positive (degree) */
    char degrees_roll;  /**< Degrees (const) */
    char roll_id[4];       /**< ID indicating roll of vessel */
} nmeaYXXDR;
